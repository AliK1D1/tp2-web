...
namespace tp2.Models
{
    public class BaseDeDonnees
    {
        ...
        public BaseDeDonnees()        
        {
            ...
            Combattants.Add(new Combattant() { Id = 3, IdCategorie = 2, Nom = "Alex Pereira", Poid = "Poids Moyen", EstChampion = true, Description = "Champion actuel", Reach = 79, Origine = "Brésil", Precision = 60, VictoiresParKO = 7, ImageUrl = "/images/alexpeiraacceuil.jpg", Ratio = new ratiocombat(12, 3, 0), Age = 33 });
